...
// import { ProcedureStateType } from '../../../../src/assets/script/client/domain/procedure/types/ProcedureType';
// import saveProcedureReducer from '../../../../src/assets/script/client/domain/fix/reducers/FixSingleReducer';
// import { ProcedureSingleTypeFixture } from '../_mocks/procedureMocks';
//
// const INITIAL_STATE = new ProcedureStateType({
//     isLoading: false,
//     payload: null,
//     error: null
// });
...
// });
//
// ava('saveProcedureReducer reducer sets payload', (t) => {
//     t.notThrows(() => {
